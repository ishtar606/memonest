...
## [2026-09-18] (통합 검색)
- **feat:** 통합 검색 — 전 모듈(할일·일정·회의록·장보기·아이디어·소설·일기) 제목/내용 검색, 결과 클릭 시 해당 모듈로 이동. PC 사이드바 검색 바 + 모바일 헤더 검색 아이콘

## [2026-09-18] (웹푸시 후속)
- **feat:** ToDo 마감 알림 + 매일 아침(09:00 KST) 오늘 요약 푸시 — 구독에 할일 DB·아침요약 저장, reminders 스케줄러가 오늘 마감 할 일과 오늘 일정/미완료 요약 발송
